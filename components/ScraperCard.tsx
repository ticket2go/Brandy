...
export default function ScraperCard({ name, url, onDelete }: ScraperCardProps) {
  return (
    <article className="group relative flex h-40 w-64 shrink-0 flex-col justify-end overflow-hidden rounded-2xl bg-black p-5">
      {onDelete && (
        <button
          type="button"
          onClick={onDelete}
